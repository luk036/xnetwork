...
breathe_projects = {"xnetwork": "./doxyoutput/xml"}
breathe_default_project = "xnetwork"
...
latex_documents = [
  (master_doc, 'xnetwork.tex', u'xnetwork Documentation',
...
man_pages = [
    (master_doc, 'xnetwork', u'xnetwork Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'xnetwork', u'xnetwork Documentation',
   author, 'xnetwork', 'One line description of project.',
   'Miscellaneous'),
]
