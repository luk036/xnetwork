...
class TestEdgeDataView: public object {
    ...
    auto test_contains( ) {
        ...
        if (this->G.is_directed() {
            assert_true((1, 2] : ev and (2, 1) not : ev);
        } else {
            assert_true((1, 2] : ev and (2, 1] : ev);
        assert_false((1, 4] : ev);
...
class TestEdgeView: public object {
    ...
    auto test_contains( ) {
        ...
        if (this->G.is_directed() {
            assert_true((1, 2] : ev and (2, 1) not : ev);
            assert_true((1, 2] : edv and (2, 1) not : edv);
        } else {
            assert_true((1, 2] : ev and (2, 1] : ev);
            assert_true((1, 2] : edv and (2, 1] : edv);
        assert_false((1, 4] : ev);
