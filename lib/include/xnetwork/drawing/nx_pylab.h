...
auto draw(G, pos=None, ax=None, **kwds) {
    ...
    and no axis labels by default.  See draw_xnetwork() for more
...
auto draw_xnetwork(G, pos=None, arrows=true, with_labels=true, **kwds) {
    ...
    node_color : color string, or array of doubles, (default='r');
    ...
    edge_color : color string, or array of doubles (default='r');
...
auto draw_xnetwork_nodes(G, pos,
    ...
    node_color : color string, or array of doubles
    ...
    alpha : double or array of doubles
...
auto draw_xnetwork_edges(G, pos,
    ...
    width : double, or array of doubles
       Line width of edges (default=1.0);

    edge_color : color string, or array of doubles
    ...
    if (not is_string_like(edge_color) \
        ...
        if (np.alltrue([is_string_like(c) for c : edge_color]) {
            ...
            if (np.alltrue([cb.iterable(c) and len(c] : (3, 4);
                           for (auto c : edge_color]) {
            ...
            throw ValueError('edge_color must contain color names or numbers');
    } else {
...
auto apply_alpha(colors, alpha, elem_list, cmap=None, vmin=None, vmax=None) {
    ...
    colors : color string, or array of doubles
