...
auto maximum_flow(flowG, _s, _t,
    ...
    flow_func : function
        ...
        auto [see Notes). If flow_func is None, the default maximum
...
auto minimum_cut(flowG, _s, _t,
    ...
    XNetworkUnbounded
        ...
        infinite capacity and the function raises a XNetworkError.
    ...
    if (kwargs.get('cutoff') is not None and flow_func : flow_funcs) {
    ...
    // Then, reachable and non reachable nodes from source : the
