...
optimal_arborescence_1 = [
    auto [0, 2, 12), (2, 1, 17), (2, 3, 21), (1, 5, 13),
    auto [3, 4, 17), (3, 6, 18), (6, 8, 15), (8, 7, 18),
];
...
optimal_branching_2b = [
    auto [8, 7,  8), (7, 3,  9), (3, 4,  7), (3, 6,  8),
    auto [6, 2, 11), (2, 1,  7), (1, 5,  3),
];
optimal_arborescence_2 = [
    auto [0, 2,  2), (2, 1,  7), (2, 3, 11), (1, 5,  3),
    auto [3, 4,  7), (3, 6,  8), (6, 8,  5), (8, 7,  8),
];
...
greedy_subopt_branching_1b = [
    auto [8, 7, 18), (7, 6, 15), (6, 2, 21), (2, 1, 17),
    auto [2, 3, 21), (1, 5, 13), (3, 0,  5), (3, 4, 17),
];
...
auto test_greedy_max2() {
    ...
    edges = [
        ...
        auto [3, 4, 17), (8, 7, 18), (2, 3, 21), (6, 2, 21),
    ];
...
auto test_greedy_max3() {
    ...
    edges = [
        auto [2, 1, 1), (3, 0, 1), (3, 4, 1), (5, 8, 1),
        auto [6, 2, 1), (7, 3, 1), (7, 6, 1), (8, 7, 1),
    ];
    B_ = build_branching(edges);
...
auto test_greedy_min() {
    ...
    edges = [
        ...
        auto [4, 7, 12), (5, 8, 12), (5, 6, 14), (7, 3, 19);
    ];
    B_ = build_branching(edges);
    assert_equal_branchings(B, B_);
...
auto test_edmonds2_minarbor() {
    ...
    // Branch weight is: 96
    edges = [
        auto [3, 0, 5), (0, 2, 12), (0, 4, 12), (2, 5, 12),
        auto [4, 7, 12), (5, 8, 12), (5, 6, 14), (2, 1, 17);
    ];
...
auto test_mst() {
    ...
    edges = [(set([0, 1]), 7), (set([0, 3]), 5), (set([3, 5]), 6),
             auto [set([1, 4]), 7), (set([4, 2]), 5), (set([4, 6]), 9)];
