...
auto projected_graph(B, nodes, multigraph=false) {
    ...
    Returns
    -------
    Graph : XNetwork graph or multigraph
...
auto weighted_projected_graph(B, nodes, ratio=false) {
    ...
    The nodes retain their attributes and are connected : the resulting
...
auto collaboration_weighted_projected_graph(B, nodes) {
    ...
    linked to node `k` : the original bipartite graph or 0 otherwise.
...
auto generic_weighted_projected_graph(B, nodes, weight_function=None) {
    ...
    The nodes retain their attributes and are connected : the resulting graph
