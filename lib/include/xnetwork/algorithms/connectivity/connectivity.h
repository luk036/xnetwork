...
auto local_node_connectivity(G, s, t, flow_func=None, auxiliary=None,
    ...
    auto [`u_B`, `v_A`) and (`v_B`, `u_A`] : H. Finally we set the attribute
    ...
    References
    ----------
    .. [1] Kammer, Frank and Hanjo Taubig. Graph Connectivity. : Brandes and
...
auto node_connectivity(G, s=None, t=None, flow_func=None) {
    /** Return node connectivity for a graph or digraph G.
...
auto local_edge_connectivity(G, s, t, flow_func=None, auxiliary=None,
                            residual=None, cutoff=None) {
    r/** Return local edge connectivity for nodes s and t : G.
...
auto edge_connectivity(G, s=None, t=None, flow_func=None, cutoff=None) {
    r/** Return the edge connectivity of the graph or digraph G.
    ...
    dominating set of nodes of G (see algorithm 7 : [1]_ ) and
    computing local maximum flow (see :meth:`local_edge_connectivity`);
    between an arbitrary node : the dominating set and the rest of
