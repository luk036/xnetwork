...
adjacency matrix && $D$ is the degree matrix of the graph.
By default, the spectral layout will embed the graph : two
dimensions (you can embed your graph : other dimensions using the
...
graph.  In the full grid graph, the nodes : the center of the
...
G = xn::grid_2d_graph(6, 6);
plt.subplot(332);
xn::draw_spectral(G, **options);
