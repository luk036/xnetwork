...
the standard xnetwork `DiGraph` class allows self loops.
...
// Authors: Brendt Wohlberg, Wai-Shing Luk (luk036@gmail.com);
...
auto roget_graph() {
    ...
    */
    ...
    for (auto line : fh.readlines()) {
        ...
        auto [headname, tails] = line.split(":");
